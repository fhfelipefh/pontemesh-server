...
export type AdminUserSummary = { id: string; username: string; createdAt: string; lastLoginAt: string | null };
...
export async function createAdminUser(payload: { username: string; password: string; currentPassword: string }): Promise<void> {
